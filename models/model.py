...
class CaFNet(nn.Module):
    ...
    def forward(self, x, radar, focal):
        ...
        feat, rad_feat, depth, final_depth = self.decoder(skip_feat, skip_feat_radar_new, focal, rad_confidence)

        return feat, skip_feat, rad_feat, depth, final_depth, rad_confidence, rad_depth
