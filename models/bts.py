...
class bts_gated_fuse(nn.Module):
    ...
    def forward(self, img_features, rad_features, focal, radar_confidence):
        ...
        radar_feat5 = rad_weight5*rad_project5*radar_confidence5
        dense_features = torch.nn.ReLU()(img_features[4])
        dense_features = dense_features + radar_feat5
        ...
        # print(iconv5.shape)
        feat.append(iconv5)
        rad_feat.append(radar_feat5)
        
        rad_weight4 = self.weight4(rad_skip3)
        rad_project4 = self.project4(rad_skip3)

        radar_feat4 = rad_weight4*rad_project4*radar_confidence4
        rad_feat.append(radar_feat4)

        iconv5 = iconv5 + radar_feat4
        ...
        radar_feat3 = rad_weight3*rad_project3*radar_confidence3
        rad_feat.append(radar_feat3)

        daspp_feat = daspp_feat + radar_feat3
        # print(daspp_feat.shape)
        feat.append(daspp_feat)
        ...
        radar_feat2 = rad_weight2*rad_project2*radar_confidence2
        iconv3 = iconv3 + radar_feat2
        # print(iconv3.shape)
        feat.append(iconv3)
        rad_feat.append(radar_feat2)
        ...
        radar_feat1 = rad_weight1*rad_project1*radar_confidence1
        iconv2 = iconv2 + radar_feat1
        # print(iconv2.shape)
        feat.append(iconv2)
        rad_feat.append(radar_feat1)
        ...
        depth.append(depth_2x2_scaled)

        upconv1 = self.upconv1(iconv2)
        reduc1x1 = self.reduc1x1(upconv1)
        # depth.append(reduc1x1)
        ...
        return feat, rad_feat, depth, final_depth
